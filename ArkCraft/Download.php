	...
	<body>
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
				...
				<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navBarArkCraft">
					<span class="icon-bar"></span>
					<span class="icon-bar"></span>
					<span class="icon-bar"></span> 
				  </button>
					<a class="navbar-brand" href="#">ArkCraft</a>
				</div>
		...
		<div id="header">
			<h1 id="headerPageTitle">ArkCraft</h1>
		</div>
		<div id="body">
		</div>
		<div id="footer">
